...
class ContentApiModule extends AbstractApiModule {
  ...
  constructor(type, parent) {
    super(App.instance, { name: `content.${type}` }, { autoInit: false });
    /**
    * Content type
    * @type {String}
    */
  ...
  async setValues() {
    ...
    /** @ignore */ this.router = this.parent.router.createChildRouter(this.root);
  ...
  async init() {
    ...
    (await this.app.waitForModule('authored')).registerModule(this);
    this.setReady();
  }
  /**
